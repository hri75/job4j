...
/**
 * Ревью:
 * 1. Лишний импорт import java.util.List; - можно удалить.
 * 2. Насколько оправдано хранить в TreeMap данные - мне непонятно, почему не использовать класс HashMap, он, наверное, быстрее работает.
 */
